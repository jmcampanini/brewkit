...
Brewkit is supported only at the latest commit on the `main` branch. There are no stable releases or supported older versions.

## Reporting a vulnerability

Report suspected vulnerabilities through [GitHub private vulnerability reporting](https://github.com/jmcampanini/brewkit/security/advisories/new).
